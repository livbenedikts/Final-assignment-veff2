...
import { TextField, Button, Switch, FormLabel, FormControl,FormControlLabel, Radio, RadioGroup } from '@mui/material';
import './styles.scss';
...
const NewRoom = () => {
    ...
    const joinRoom =(e) => {
        ...
        const joinObj = {room, user, pass: isPasswordEnabled ? password : undefined };
    ...
    return (
        <div className='createRoomContainer'>
            ...
            <div className='roomNameTopicContainer'> 
                ...
                <Button onClick={(e) => joinRoom(e)} variant="contained">Create room</Button>
